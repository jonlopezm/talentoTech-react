...
import { useGetHouseByIdQuery, useUpdateHouseMutation, useUploadAvatarMutation } from '../../features/api/apiHousesSlice';
...
export default function HouseFormEdit() {
    ...
    const { data: house, error, isLoading, isError } = useGetHouseByIdQuery(params.id);
    ...
    return (
        <HouseForm props={{ handleSubmit : handleSubmit, handleChangeAvatar: handleChangeAvatar, house:house }} /> 
    );
}